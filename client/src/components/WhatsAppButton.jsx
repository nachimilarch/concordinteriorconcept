 ...
 *
 * Special-case the homepage cinematic journey:
...
export default function WhatsAppButton({ number = "919876543210" }) {
  ...
  useEffect(() => {
    ...
    // On the home page, only reveal after the user has scrolled
    // past the cinematic journey (approx. 5 viewport heights).
    const onScroll = () => {
  ...
  return (
    ...
    >
      <span style={{
        ...
        animation: "wapulseGold 2.2s ease-out infinite",
        pointerEvents: "none",
      }} />
      <style>{`
